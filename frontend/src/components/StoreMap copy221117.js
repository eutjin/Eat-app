...
function StoreMap() {
  ...
  const kakaoMap = () => {
    ...
    var mapContainer = document.getElementById("map"), // 지도를 표시할 div
      mapOption = {
        center: setCenter(),
        // center: new kakao.maps.LatLng(37.480142, 126.879028), // 지도의 중심좌표
        level: 4, // 지도의 확대 레벨
      }; //hereee changed
  ...
  return (
    <div className="mapPage">
      ...
      <MapAddressControl radiusControlActive={radiusControlActive} setRadiusControlActive={setRadiusControlActive} sortControlActive={sortControlActive} setSortControlActive={setSortControlActive}/>
      <MapControlSort sortControlActive={sortControlActive} setSortControlActive={setSortControlActive}/>
